...
from typing import (
    Any, Callable, Concatenate, Dict, List, Optional,
...
def validate_output(
    func: Callable[Concatenate[_Self, str, str, _P], _T]
) -> Callable[Concatenate[_Self, str, str, _P], _T]:
...
class ArchiveDataGenerator:
    ...
    def _format_content(self, template_data: Dict[str, Any]) -> str:
        ...
        content: Union[str, List[str]] = template_data.get("content", "")
