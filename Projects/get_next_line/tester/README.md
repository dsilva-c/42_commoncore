...
- `.../get_next_line/`        ← Project root (contains `get_next_line.c`, `.h`, etc.)
- `.../get_next_line/tester/` ← This tester folder
...
- **`get_next_line.h: No such file or directory`**
  ➜ Ensure the tester is inside the `get_next_line/tester/` folder.
