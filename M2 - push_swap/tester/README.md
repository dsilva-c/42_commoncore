...
- `.../M2 - push_swap/`        ← Project root (contains `Makefile`, source files)
- `.../M2 - push_swap/tester/` ← This tester folder
...
- **`../push_swap not found!`**  
  ➜ Ensure the tester is inside the `M2 - push_swap/tester/` folder and run `make run` (it builds automatically).
